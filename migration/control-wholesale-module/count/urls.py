...
urlpatterns = [
        ...
        path('customer/account-search', views.CustomerAccountSearchView.as_view(), name='customer-account-search'),
        ...
        path('platform/toggle/<int:pk>', views.TogglePlatformStatusView.as_view(), name='toggle-platform-status'),
        path('platform/delete/<int:pk>', views.DeletePlatformView.as_view(), name='delete-platform'),
